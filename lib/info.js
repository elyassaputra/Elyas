exports.info = (id, ELYASBOT, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `⚜ ${ELYASBOT} ⚜
...
INFO BOT! :
🔱 *AUTHOR*: ELYAS
🔱 *GITHUB*: https://github.com/elyassaputra/Elyasbot
🔱 *INSTAGRAM*: ${instagram}
🔱 *YOUTUBE*: ${youtube}
🔱 *TELEGRAM* : ${telegram}
🔱 *WHATSAPP* : 088989197937

🔱 *SCRIPT ORIGINAL BY*: https://github.com/fdciElyas
